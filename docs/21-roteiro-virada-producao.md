...
| Cliente recebeu "MISSÃO 1 CONCLUÍDA" sem ter entrado em campanha | Handoff para a campanha legada (corrigido em 22/09/2026) | `node scripts/handoff-indevido.js` lista quem ficou com sessão aberta; `--aplicar` remove |
