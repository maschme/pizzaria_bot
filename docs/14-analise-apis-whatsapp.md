...
| Listar grupos em número novo | ✅ Passou no `bot-teste1` — logo após o pareamento a lista vem vazia; a sincronização ao conectar tenta de novo até os grupos aparecerem | 23/09/2026 |
